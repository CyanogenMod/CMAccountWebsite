...
var DeviceFindController = function($scope, $routeParams, $http, $timeout, $analytics, SecureMessageService, Device, API_BASE) {
  ...
  $scope.authenticate = function() {
    ...
    SecureMessageService.openChannel().then(function() {
      ...
      SecureMessageService.sendGCM(deviceKey, hashedPassword, $scope.device.salt, {command: 'begin_locate'});
    });
    $timeout(function() {
...
var DeviceWipeController = function($scope, $routeParams, $http, $timeout, $analytics, API_BASE, Device, SecureMessageService) {
  ...
  $scope.authenticate = function() {
    ...
    SecureMessageService.openChannel().then(function() {
      ...
      SecureMessageService.sendGCM(deviceKey, hashedPassword, $scope.device.salt, {command: 'begin_wipe'});
    });
    $timeout(function() {
