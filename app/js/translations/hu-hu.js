...
(function() {
  angular.module('cmaccount.l10n.hu-hu', ['l10n']).config(['l10nProvider', function(l10n) {
    l10n.add('hu-hu', {
      ...
      // Register Partial
      register: {
        create: "Hozza létre a CyanogenMod fiókját",
      ...
      learn_more: {
        ...
        what_is_cmaccount: {
          title: "Mit is jelent a CyanogenMod fiók?",
        ...
        secure: {
          title: "Biztonságos?",
          communication: "Az Ön böngészője vagy készüléke és a szervereink közötti kapcsolat SSL titkosítású.  Továbbá a kommunikáció során a jelszavakat soha nem küldjük titkosítatlanul.",
          priority: "A funkciók jellege miatt a \'Készülék keresése\' és a \'Távoli törlés\' funkcióknál is számunkra a biztonság volt az első számú szempont. Jelszóhitelesítés nélkül nem használható a helymeghatározást illetve a távoli törlés funkció. Az eszközzel történő teljes kommunikáció, beleértve a helymeghatározás adatai titkosított és a CyanogenMod csapat, partnerei, valamint a szerverei számára elérhetelen módon van kezelve.",
        },
      ...
      remove_device: {
        problem: "Hiba történt a fiókhoz tartozó az eszköz eltávolítása során.",
