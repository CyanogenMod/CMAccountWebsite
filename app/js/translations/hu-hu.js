    ...
    l10n.add('hu-hu', {
      ...
      learn_more: {
        ...
        secure: {
          ...
          priority: "A funkciók jellege miatt számunkra a \'Készülék keresése\' és a \'Távoli törlés\' funkcióknál is a biztonság volt az első számú szempont. Jelszóhitelesítés nélkül nem használható a helymeghatározás illetve a távoli törlés funkció. Az eszközzel történő teljes kommunikáció (beleértve a helymeghatározás adatait) titkosított és a CyanogenMod csapat, partnerei, valamint szerverei számára elérhetetlen módon van kezelve.",
        },
