  ...
  angular.module('cmaccount.l10n.ru', ['l10n']).config(['l10nProvider', function(l10n) {
    l10n.add('ru', {
      ...
      verify_email: {
        ...
        no_longer_valid: "Ссылка уже не действительна.",
      },

      // Learn More Partial
      learn_more: {
        learn_more: "Узнать ещё",
        ...
        personal_info: {
          ...
          required: "Для создания аккаунта CyanogenMod требуется только базовая информация, включая e-mail адрес.",
          // Note: This string ends with a link to "Privacy Policy"
          // TODO(ctso): Implement a way to safely embed html in the translations.
          usage: "CyanogenMod никому и никогда не будет передавать ваши персональные данные. Эти данные будут использоваться только в рамках наших",
        },

        secure: {
          title: "Это безопасно?",
          communication: "Любое соединение между вашим браузером или устройство и нашими серверами шифруется, используя SSL. Кроме того, мы никогда не передаём пароль в открытом виде.",
      ...
      devices: {
        ...
        locate_device: "Найти устройство",

        remote_wipe: "Удалённый сброс",
        remove_device: "Удалённый сброс",
      },

      // Secure Message Partials (find/wipe)
      secure_message: {
        locate_device: "Поиск устройства",
        authentication_failure: "Ошибка идентификации!",
        ...
        invalid_password: "Вы ввели не правильный пароль или истекла ваша сессия",

        enter_password: "Пожалуйста, введите ваш пароль для соединения с устройством.",
        ...
        wait_wipe: "Пожалуйста, подождите, пока мы сбросим настройки вашего устройства.",
        wipe_started: "Начат сброс настроек.",
      },
