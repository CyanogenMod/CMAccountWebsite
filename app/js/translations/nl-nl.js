(function() {
  angular.module('cmaccount.l10n.nl-nl', ['l10n']).config(['l10nProvider', function(l10n) {
    l10n.add('nl-nl', {
      ...
      password_reset: {
        title: "Wachtwoord van CyanogenMod-account herstellen",
        reset_password: "Wachtwoord herstellen",
      },

      verify_email: {
        title: "Uw e-mailadres bevestigen",
        must_verify: "Voordat u uw CyanogenMod-account kunt gebruiken, dient u uw e-mailadres te bevestigen. Toen u u hebt geregistreerd, hebben wij u een e-mail gestuurd met een link die u dient te openen.",
      ...
      learn_more: {
        ...
        what_is_cmaccount: {
          ...
          text: "Een CyanogenMod-account biedt toegang tot extra diensten en functies voor uw apparaten die CyanogenMod draaien.",
        },
        ...
        benefits: {
          title: "Wat zijn de voordelen aan een account?",
          text: "Door een CyanogenMod-account te maken is het mogelijk om, ten minste, uw apparaat te lokaliseren en op afstand te wissen.",
        },
      },
      ...
      secure_message: {
        ...
        wait_wipe: "Een ogenblik geduld a.u.b. Er wordt geprobeerd uw apparaat wordt te wissen.",
