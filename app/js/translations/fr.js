...
(function() {
  angular.module('cmaccount.l10n.fr', ['l10n']).config(['l10nProvider', function(l10n) {
    l10n.add('fr', {
      // Generic
      email: "E-mail",
      ...
      learn_more: {
        ...
        secure: {
          ...
          communication: "Tous les échanges entre votre navigateur ou votre appareil et nos serveurs sont chiffrés à l'aide de SSL. De plus, nous ne vous enverrons jamais votre mot de passe en clair depuis nos serveurs.",
      ...
      secure_message: {
        ...
        encryption_failure: "Un problème a été rencontré lors de l'ouverture d'un cannal sécurisé avec votre appareil. Réessayez ultérieurement.",
      ...
      account: {
        ...
        error_complexity: "Votre mot de passe doit être d'au moins huit (8) caractères.",
