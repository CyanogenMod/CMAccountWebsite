  ...
  angular.module('cmaccount.l10n.zh-tw', ['l10n']).config(['l10nProvider', function(l10n) {
    l10n.add('zh-tw', {
      ...
      learn_more: {
        ...
        secure: {
          title: "它安全嗎？",
          communication: "您的瀏覽器或裝置和我們的伺服器之間的所有通信都經 SSL 加密。此外，我們永遠不會用純文本形式把您的密碼發送到我們的伺服器。",
          priority: "鑑於 \“定位我的手機\” 和 \“遠端 Wipe \” 功能的性質，我們的首要任務是安全至上。若不先使用密碼進行身份驗證，你將不能定位或擦拭裝置。所有的裝置之間的通信，包括位置資訊，是加密和不可被 CyanogenMod 的任何伺服器，人員，或合作夥伴存取的。",
        },

        benefits: {
          title: "擁有有一個帳戶能為我帶來什麼?",
          text: "通過建立一個 CyanogenMod 帳戶，至少你將能夠為您的裝置存取 \“定位我的手機\” 和 \“遠端 Wipe \” 功能。",
        },
      },
      ...
      remove_device: {
        ...
        confirm: "你確定要移除此裝置？",
        warning_message: "如果從 CyanogenMod 帳戶移除此裝置，你將不能夠再使用我們提供的功能，如定位或遠端 Wipe 裝置。",
      },
    });
  }]);
}).call(this);
