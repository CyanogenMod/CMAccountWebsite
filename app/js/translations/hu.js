...
(function() {
  angular.module('cmaccount.l10n.hu', ['l10n']).config(['l10nProvider', function(l10n) {
    l10n.add('hu', {
      // Generic
      email: "E-mail cím",
      password: "Jelszó",
      ...
      learn_more: {
        ...
        personal_info: {
          ...
          usage: "A CyanogenMod csapat soha nem adja ki az Ön személyes adatait.  További információ itt olvasható: ",
        },

        secure: {
          title: "Biztonságos?",
          communication: "Az Ön böngészője vagy készüléke és a szervereink közötti kapcsolat SSL titkosítású.  A kommunikáció során jelszavakat soha nem küldünk titkosítatlanul.",
        ...
        benefits: {
          title: "Mit nyújt a CyanogenMod fiók?",
      ...
      remove_device: {
        ...
        warning_message: "Ha eltávolítja az eszközt a CyanogenMod fiókjából, többé nem fogja tudni használni a helymeghatározás és távoli törlés funkciókat.",
      },
    });
  }]);
}).call(this);
