(function() {
  angular.module('cmaccount.l10n.es', ['l10n']).config(['l10nProvider', function(l10n) {
    l10n.add('es', {
      ...
      verify_email: {
        ...
        must_verify: "Debes verificar tu dirección de correo electrónico antes de poder usar tu cuenta de CyanogenMod. Cuando te registres, te enviaremos un correo electrónico con un enlace que deberás seguir.",
      ...
      learn_more: {
        ...
        do_i_need: {
          ...
          text: "La creación de una cuenta de CyanogenMod no es necesaria para ejecutar CyanogenMod en tu dispositivo. En cualquier caso, ciertas funcionalidades o servicios proporcionados por CyanogenMod, como por ejemplo \«Ubicar dispositivo\» requieren de una cuenta de CyanogenMod para ser accesibles.",
        },
        ...
        secure: {
          ...
          priority: "Dada la naturaleza de las funcionalidades \«Ubicar dispositivo\» y \«Borrado remoto\», la seguridad es nuestra mayor prioridad. No podrás ubicar o borrar tu dispositivo sin haberte identificado con tu contraseña previamente. Todas las comunicaciones realizadas con tu dispositivo, incluyendo la información de ubicación, están cifradas y son inaccesibles para cualquier persona, colaborador o servidor de CyanogenMod.",
        },

        benefits: {
          title: "¿Qué me da una cuenta?",
          text: "Al crear una cuenta de CyanogenMod tendrás, como mínimo, acceso a \«Ubicar dispositivo\» y \«Borrado remoto\» para tu dispositivo.",
        },
      },
      ...
      devices: {
        ...
        locate: "Ubicación",
        locate_device: "Ubicar dispositivo",
      ...
      secure_message: {
        ...
        wait_locate: "Por favor, espera mientras intentamos ubicar tu dispositivo.",
      ...
      remove_device: {
        ...
        warning_message: "Si eliminas este dispositivo de tu cuenta de CyanogenMod, ya no podrás utilizar las funcionalidades de ubicación ni borrado remoto de tu dispositivo.",
      },
    });
  }]);
}).call(this);
