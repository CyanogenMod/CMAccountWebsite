    ...
    l10n.add('ja', {
      ...
      learn_more: {
        ...
        secure: {
          ...
          priority: "\ "私の電話を探す\ "および\ "リモートワイプ\"機能の性質を考えると、セキュリティは私達の最優先事項です。最初にあなたのパスワードを使用して認証することなく、デバイスを見つけたり、ワイプすることは不可能です。位置情報を含むお使いのデバイスとのすべての通信は、暗号化され、CyanogenModサーバ、関係者、またはパートナーにアクセスできません。",
        },
