    ...
    l10n.add('en', {
      ...
      learn_more: {
        ...
        personal_info: {
          ...
          usage: "CyanogenMod wird Ihre persönlichen Daten niemals verkaufen. Ihre Daten werden nur in Übereinstimmung mit unseren Datenschutzbestimmungen genutzt.",
        },
      ...
      secure_message: {
        ...
        encryption_failure: "Beim Aufbau einer sicheren Verbindung ist ein Problem aufgetreten. Bitte versuchen Sie es in ein paar Minuten erneut.",
