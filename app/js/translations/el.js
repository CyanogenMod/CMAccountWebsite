  ...
  angular.module('cmaccount.l10n.el', ['l10n']).config(['l10nProvider', function(l10n) {
    l10n.add('el', {
      ...
      secure_message: {
        ...
        encryption_failure: "Υπήρξε πρόβλημα κατά το άνοιγμα ασφαλούς καναλιού επικοινωνίας με τη συσκευή σας. Παρακαλώ δοκιμάστε ξανά σε λίγα λεπτά.",
      ...
      account: {
        ...
        alert_invalid: "Ο τρέχων κωδικός πρόσβασης που πληκτρολογήσατε είναι λάθος.",
        alert_success: "Ο κωδικός πρόσβασής σας άλλαξε με επιτυχία.",
        change_password: "Αλλαγή κωδικού",
        current_password: "Τρέχων κωδικός",
        new_password: "Νέος κωδικός",
        confirm_new_password: "Επιβεβαίωση νέου κωδικού",
        error_complexity: "Ο κωδικός πρόσβασής σας πρέπει αποτελείται από τουλάχιστον οκτώ (8) χαρακτήρες.",
        error_match: "Οι κωδικοί πρόσβασης που πληκτρολογήσατε δεν ταιριάζουν."
      },
    });
  }]);
}).call(this);
