...
(function() {
  angular.module('cmaccount.l10n.zh-cn', ['l10n']).config(['l10nProvider', function(l10n) {
    l10n.add('zh-cn', {
      ...
      verify_email: {
        title: "验证您的电子邮件地址",
        must_verify: "您必须验证您的电子邮件地址，然后才可以使用您的CyanogenMod 账户。当您注册后，我们会给您发送一封电子邮件，您必须按照其中的链接完成验证。",
      ...
      learn_more: {
        ...
        do_i_need: {
          ...
          text: "创建 CyanogenMod 账户不需要使用您设备上的 CyanogenMod。CyanogenMod 提供的某些功能或服务，例如 \"定位我的手机\" 需要一个CyanogenMod 账户去存取。",
        },
